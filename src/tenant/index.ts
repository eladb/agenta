...
// Env-derived model fallback. Under the bot↔tenant split (#253) this IS
// the model triplet for every turn — the bot's envelope no longer carries
// a model block. The api_key_env name we pin here (`MODEL_API_KEY` or
