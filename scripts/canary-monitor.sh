#!/usr/bin/env bash
# canary-monitor.sh — 30-min double-canary watchdog for the agenta + acme bots.
#
  ...
  if jq -nc \
    ...
    '{
      ...
      targets: [
        ...
        {name: "acme",  cloud: "ECS", status: $ecs_status, checked_at: $ecs_at}
      ]
